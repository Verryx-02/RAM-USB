...
// tracker, feeding ST-F-12/ST-F-13's metrics.Counters with real traffic
// data. Identical shape to Database-Vault's and Network-Manager's own
// httpapi.Counters (DV-F-16/DV-F-17, NM-F-17/NM-F-18) - every field is a
// sync/atomic value: Record and Snapshot may be called concurrently from
// any number of request-handling goroutines and, separately, from
// metrics.Run's once-a-minute publish goroutine.
...
// (ST-F-12/ST-F-13's payload input) at the moment it's called. Does not
// reset the accumulated totals - same running-total convention as
// Database-Vault's and Network-Manager's own Snapshot.
