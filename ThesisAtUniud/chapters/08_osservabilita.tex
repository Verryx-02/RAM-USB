...
connessione verso ciascuno dei sei servizi, ampliando le regole di raggiungibilità della mesh discusse nel
\autoref{chap:rete}.
...
Le metriche nel payload fanno riferimento al minuto in cui sono state inviate.
...
Le pubblicazioni usano tutte \emph{QoS 1}, (at least once) nella classificazione MQTT \cite{oasis-mqtt-311}: il
...
amministrativa di Headscale nel \autoref{chap:rete}.
