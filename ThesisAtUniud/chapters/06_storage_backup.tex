...
Il client, all'inizializzazione della repository Restic, estrae 32 byte da \texttt{crypto/rand}, li
...
Restano fuori gli altri modi di autenticarsi e gli altri usi che SSH consente di norma, come eseguire un comando, 
...
scaduto quello, il nodo dell'utente non vede più il servizio e la connessione non inizia nemmeno. Il
...
Il ripristino percorre la stessa strada del backup; l'unica differenza è il comando impartito a
