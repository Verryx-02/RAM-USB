...
Gli errori interni vengono infine tradotti in codici HTTP. La \autoref{tab:codici-http} li
riassume, indicando per ciascuno se a costruirlo sia Entry-Hub, Security-Switch o entrambi.
...
la chiave privata SSH. Conoscere le credenziali dell'utente non è pertanto condizione sufficiente ad 
accedere ai suoi backup.
