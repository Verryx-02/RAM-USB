...
| KI-26 | `ramusb-net`'s bootstrap-phase role, live-verified per service: Database-Vault/Security-Switch/Storage-Service survive without it, Network-Manager does not (Entry-Hub's own gap fixed as KI-27) | user decision (Network-Manager needs a scoped DNS mechanism) |
...
KI-16–KI-18, KI-21, KI-22, KI-25, KI-27) is `FIXED` — kept below for
