...
|CL-F-02|Following a user command, must send only the SSH public key to Entry-Hub during registration (`POST /api/register`), together with email and password|[Code](https://github.com/Verryx-02/RAM-USB/blob/7c1e991f953a4c686e09f8142d0b3c1d9d64fc5f/user-client/internal/entryhub/client.go#L121-L144)|
...
|EH-F-02|Must expose a public HTTPS endpoint for user registration:<br>`POST /api/register`,<br>with certificates signed by the **public** Let's Encrypt CA|[Code](https://github.com/Verryx-02/RAM-USB/blob/7c1e991f953a4c686e09f8142d0b3c1d9d64fc5f/services/entry-hub/internal/httpapi/handler.go#L100-L124)|
|EH-F-03|Must expose an HTTPS endpoint<br>`POST /api/login`<br>for the authentication of registered users, reachable only by them, <br>with certificates signed by the **public** Let's Encrypt CA|[Code](https://github.com/Verryx-02/RAM-USB/blob/7c1e991f953a4c686e09f8142d0b3c1d9d64fc5f/services/entry-hub/internal/httpapi/handler.go#L130-L154)|
